...
val MovieHubLightSurfaceLow = Color(0xFFEAF0ED)
val MovieHubLightSurfaceContainer = Color(0xFFE5EBE8)
val MovieHubLightSurfaceHigh = Color(0xFFDDE5E1)
val MovieHubLightPrimary = Color(0xFF006B2A)
val MovieHubLightSecondary = Color(0xFF00658A)
val MovieHubLightRating = Color(0xFF9A4600)
val MovieHubLightOnSurface = Color(0xFF171D19)
val MovieHubLightOnSurfaceVariant = Color(0xFF414943)
val MovieHubLightOutline = Color(0xFF68736F)
val MovieHubLightOutlineVariant = Color(0xFFC5CEC9)
